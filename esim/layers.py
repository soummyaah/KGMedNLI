...
class Seq2SeqEncoder(nn.Module):
    ...
    def forward(self, sequences_batch, sequences_lengths, total_length):
        """
        Args:
...
class SoftmaxAttention(nn.Module):
    ...
    def forward(self,
        ...
        Returns:
            ...
            similarity_matrix: The dot product between premises and hypothesis 
                in the input batch.
        """
...
class WeightedAttention(nn.Module):
    ...
    def forward(self,
        ...
        # Dot product between premises and hypotheses in each sequence of
        # the batch.
        similarity_matrix = premise_batch.matmul(self.w.matmul(hypothesis_batch.transpose(2, 1)
                                                              .contiguous()))
